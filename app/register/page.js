...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-100 p-4 font-sans relative overflow-hidden">
      ...
      {notif.show && (
        <div className={`fixed top-10 left-1/2 -translate-x-1/2 z-[100] flex items-center gap-3 px-8 py-4 rounded-[2rem] shadow-2xl animate-in fade-in slide-in-from-top-10 duration-500 min-w-[320px] justify-center ${
      ...
      <div className="bg-white p-10 rounded-[3rem] shadow-[0_32px_64px_-15px_rgba(0,0,0,0.1)] w-full max-w-md border border-slate-100 relative z-10">
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          <div>
            ...
            <input
              ...
              placeholder="email@steamberkah.com"
              required
            />
          </div>

          <div>
            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2 mb-2 block">Create Password</label>
            <input
              type="password"
              value={password}
          ...
          <div>
            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2 mb-2 block">Confirm Password</label>
            <input
              type="password"
        ...
        <div className="mt-8 text-center">
           <p className="text-xs font-bold text-slate-400">
             Sudah punya akun? 
             <Link href="/login" className="text-blue-600 ml-2 font-black uppercase tracking-tighter hover:underline">Login Disini</Link>
           </p>
        </div>
      </div>
    </div>
